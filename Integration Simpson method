...
train_sample_number = int(input("sample sayısı : "))

for i in range(train_sample_number):
    X_train.append(float(input("train x değerlerini giriniz : ")))
    Y_train.append(float(input("train y değerlerini giriniz : ")))
